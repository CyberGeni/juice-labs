      ...
      <div className='grid grid-cols-3 place-items-center'>
        ...
        <div className='col-span-1 justify-self-end flex items-center space-x-5'>
          ...
          <div className='hidden sm:flex items-center space-x-1'>
            ...
            <span>en</span>
            <svg className='w-3' width="14" height="8" viewBox="0 0 14 8" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <button className='text-white bg-[#25513A] px-4 py-2 rounded-3xl border-2 border-black border-b-black border-b-4 hover:border-b-2 transition-all'>shop now</button>
        </div>
      </div>
    </header>
  )
