...
function Navbar() {
  return (
    <header className='px-[5%] py-4 border-b-2 border-black font-athletics font-medium text-black'>
      <div className='grid grid-cols-3 place-items-center'>
        ...
        <div className='col-span-1 place-self-end flex items-center space-x-5'>
